...
# OUTPUT Directory Hierarchy for rMAP-WDL-Cromwell-Docker Pipeline
...
- `execution/` – Shell scripts and logs for the task.
- `stdout` / `stderr` – Standard output and error logs.
